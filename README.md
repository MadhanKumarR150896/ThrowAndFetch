...
# Have used 'keyframes' to produce the animations and used time delay to create a 15 second scene with sequential flow .
# Used 'DOM' to get the ball and sun 
# Used Event Listeners to trigger the action through 'click' and also by 'keydown'
